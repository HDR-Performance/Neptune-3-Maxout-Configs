...
class Panel(ScreenPanel):
    ...
    def load_generated_points(self):
        try:
            ...
            return
        # Version 1 of this panel could save mirrored X/Y points. Do not reuse
        # those UI-generated coordinates; model baselines and migrated native
        # sections remain valid and are still loaded.
        if text.startswith("# Generated by HDR Performance Bed Screw Location.") and "# schema_version: 2" not in text:
            return
        found = []
